# CMAD — Consulting Method for Agile AI-Driven Delivery

CMAD is an open-source expansion module for the [BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) framework that adapts BMAD's agentic development workflow for **consulting engagements**.

Where BMAD provides agents for software teams (Developer, Scrum Master, Architect), CMAD provides agents that mirror real consulting roles: Business Development, Project Manager, Lead Assessor, Compliance Analyst, Technical Writer, and QA Reviewer.
...
# Install CMAD module
# Copy the cmad/ directory into your project's custom modules path
cp -r cmad/ _bmad/_config/custom/cmad/
