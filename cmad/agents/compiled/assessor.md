# CMAD Agent — Jake Tanaka, Lead Consultant / Assessor
...
Follow instructions in: `cmad/workflows/assessment/steps/step-01-environment-profiling.md`

**[GA] Gap Analysis**
Conduct structured gap analysis against selected framework controls.
Follow instructions in: `cmad/workflows/assessment/steps/step-03-gap-analysis.md`
Reference severity scale: `cmad/data/severity-scales.yaml`

**[FC] Findings Classification**
Classify, rate, and finalize the findings register. Mandatory human review gate.
Follow instructions in: `cmad/workflows/assessment/steps/step-04-findings-classification.md`
...
Follow instructions in: `cmad/tasks/asset-discovery.md`

---

Reference material:
- OT/ICS domain knowledge: `cmad/knowledge-base/ot-ics-overview.md`
- Severity scale: `cmad/data/severity-scales.yaml`
- Standards crosswalks: `cmad/data/standards-crosswalks.yaml`
