...
After completing all four steps (prioritization, roadmap, effort estimation, quick wins), produce the final remediation plan deliverable by assembling these outputs into the template at `_bmad/cmad/templates/remediation-roadmap-template.md`. Save as: `deliverables/{{engagement_name}}-remediation-roadmap.md`.
